...
public class CitiesElemJSON {

    @XmlElement(name = "Cities")
    protected List<CitiesElemJSON.CityElem> cityElem;
     ...
     * {@link com.irets.datadownloader.CitiesElemJSON.CityElem }
     *
     *
     */
    public List<CitiesElemJSON.CityElem> getCityElem() {
        if (cityElem == null) {
            cityElem = new ArrayList<CitiesElemJSON.CityElem>();
        }
