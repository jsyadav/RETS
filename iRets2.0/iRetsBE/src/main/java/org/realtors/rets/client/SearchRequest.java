...
public class SearchRequest extends RetsHttpRequest {
	...
	public static final String KEY_COEDATE = "COEDATE";
	...
	public SearchRequest(String stype, String sclass, String query) {
		init(stype, sclass, query, null);
	}
	*/
	public SearchRequest(String stype, String sclass, String query, String versionStr) {
		...
		if (versionStr != null){
			String s[] = versionStr.split("=");
			if (s.length == 2){
				setQueryParameter(s[0],s[1]);
			}
		}		
        setCountFirst();
	}
