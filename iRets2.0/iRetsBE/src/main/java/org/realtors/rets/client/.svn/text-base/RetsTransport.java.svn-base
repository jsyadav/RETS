...
public class RetsTransport {
	 ...
	 *
	 * @see org.realtors.rets.client.RetsHttpClient#setUserCredentials
	 */
	 ...
	 * @throws org.realtors.rets.client.RetsException if the login failed or something went wrong on the
	 * network
	 * @see #setCapabilities
	 */
	 ...
	 * @throws org.realtors.rets.client.RetsException if there is a network or remote server error
	 */
	 ...
	 * @throws org.realtors.rets.client.RetsException if the request is not valid or a network error
	 * occurs
	 */
