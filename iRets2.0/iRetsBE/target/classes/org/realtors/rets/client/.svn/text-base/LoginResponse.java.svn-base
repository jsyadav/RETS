...
public class LoginResponse extends KeyValueResponse {
	...
	private static final String METADATA_TS_KEY = "MetadataTimestamp";
	private static final String MIN_METADATA_TS_KEY = "MinMetadataTimestamp";
	...
	protected void handleKeyValue(String key, String value) throws RetsException {
		...
		} else if (matchKey(key, METADATA_TS_KEY)) {
			this.metadataTimestamp = value;
		} else if (matchKey(key, MIN_METADATA_TS_KEY)) {
